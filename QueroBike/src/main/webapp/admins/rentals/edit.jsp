...
<html>
  <fmt:bundle basename="messages.admins.rental_edit">
      <head>
      ...
      <body  class="d-flex flex-column justify-content-between">
        ...
        <div class="container" id="root">
          ...
          <form action="<%=contextPath%>/admins/rentals/edit" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="password" minlength="5" name="password" class="form-control" id="inputPassword">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" name="city" class="form-control" id="inputCity" value="${rental.city.name}" required>
            </div>
            <div class="form-group">
              <label for="inputState"><fmt:message key="stateLabel"/></label>
              <input type="text" name="state" class="form-control" id="inputState" value="${rental.city.state}" required>
            </div>
