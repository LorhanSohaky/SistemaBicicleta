...
%>
<!DOCTYPE html>
<fmt:bundle basename="messages.customers.update">
    <html>
      <head>
        ...
        <div class="container"  id="root">
          ...
          <form action="<%=contextPath%>/customers/update" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="password" minlength="5" name="password" class="form-control" id="inputPassword" placeholder="<fmt:message key='passwordPlaceholder'/>">
            </div>
            <div class="form-group">
